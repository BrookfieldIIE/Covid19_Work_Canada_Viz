...
ui <- fluidPage(theme="style.css",
    ...
    div(class="mobilescreen",
        fluidRow(style="font-family: rooneysanslight !important; text-align:center; padding-bottom:50px",
                 p("Thank you for your interest in exploring how Covid-19 might change work in Toronto."),
                 p("Unfortunately, this interactive data visualization can only be experienced on a larger screen at this time.",
                 "If you are unable to do so, please visit the",a("accompanying blog post",href="https://brookfieldinstitute.ca/commentary/anything-but-static-risks-of-covid-19-to-workers-in-canada"), "which explores insights from the national version of this visualization."))),

        # Show a plot of the generated distribution
    div(class="desktopscreen",
             fluidRow(
                      fluidRow(style="margin-left:0%; margin-right:0%;padding-bottom:10px",class="sectiontitlewrapper",
                               h3("Covid-19 and Work in Toronto"),
                      ...
                      fluidRow(style="margin-left:0%; margin-right:0%;",
                               div(p("COVID-19 is increasingly disrupting our economy and how we work, becoming more than a public health crisis.",
                                   ...
                                   p("This is a Toronto-specific version of the",a("national data visualization",href="https://brookfieldiie.shinyapps.io/COVID19-Work-in-Canada/"), "we developed."),
                                   ...
                                   p("For a static write-up of the national data visualization, please consult",a("this blog",href="https://brookfieldinstitute.ca/commentary/anything-but-static-risks-of-covid-19-to-workers-in-canada"),"authored by Viet Vu and Nisa Malli.")
                                   )
                               ),
                               ...
                               , scrolly_sections(
                                 scrolly_section( id = "Introduction2",
                                                  ...
                                                  p("On the right is the key graph we are exploring. Each dot in this graph represents an",
                                                    ...
                                                    ,"people working in that occupation in Toronto; smaller dots reflect", 
                                 ...
                                 scrolly_section(id = "Education Workers",
                                                 ...
                                                 p("Education workers, such as",
                                                   ...
                                                   "normally face relatively high risks in terms of both exposure and proximity. However, currently almost all educational institutions in Toronto have shifted to online delivery or have temporarily closed, which reflects how abruptly labour conditions can change.",
                                                   style="padding-bottom:200px")
                                 ),
                                 ...
                                 scrolly_section(id = "Work From Home",
                                                 ...
                                                 p("For some workers, exposure risks can be somewhat mitigated by working from home, reducing exposure on the job as well as while commuting. Using data from the", 
                                                   a("General Social Survey",.noWS = "after",href="https://www23.statcan.gc.ca/imdb/p2SV.pl?Function=getSurvey&SDDS=5221"),
                                                   ", this graph identifies which occupations (nationally)",
                                 ...
                                 scrolly_section(id="Second order",
                                                 ...
                                                 p("The impacts of COVID-19 on Toronto’s workers do not stop with health risks.",
                                                   ...
                                                   ". Nearly",
                                                   a("6 million people applied for the new Canada Emergency Response Benefit",.noWS = "after",href="https://www.cbc.ca/news/politics/covid19-benefits-cerb-1.5530722"),
                                 ...
                                 scrolly_section(id="Visible Minority Workers",
                                                 ...
                                                 p("Finally, other intersectionalities are at play here, including demographics that are more likely to work in higher risk jobs or to have other health conditions.", 
                                                   ...
                                                   span("40% of workers belong to a visible minority community",style="font-family:rooneysansmedium !important; color: #e24585"),
                                                   ...
                                                   span("73% of Licensed Practical Nurses",style="font-family:rooneysansmedium !important; color: #e24585"),
                                                   "and",
                                                   span("58% of Registered Nurses",style="font-family:rooneysansmedium !important; color: #e24585"),
                                                   "in Toronto belongs to a visible minority community.",
    ...
    fluidRow(class="alignedrow",
            p("As of the date of publication, April 23rd, 2020, we are still at the early stages of this pandemic.",

...
ui <- fluidPage(theme="style.css",
                               ...
                               , scrolly_sections(
                                 scrolly_section( id = "Introduction2",
                                                  ...
                                                  p("On the right is the key graph we are exploring. Each dot in this graph represents an",
                                                    ...
                                                    ,"people working in that occupation in Canada; smaller dots reflect less people working in that occupation.",
                                 ...
                                 scrolly_section(id="Older Folks",
                                                 ...
                                                 p(a("Available evidence",href="https://nationalpost.com/health/how-people-over-65-can-do-more-to-protect-themselves-from-covid-19"),
                                                   "suggests that individuals aged 65 or above are at an elevated risk of serious complications from COVID-19. This graph highlights occupations where", 
                                 ...
                                 scrolly_section(id="Second order",
                                                 ...
                                                 p("The impacts of COVID-19 on Canada’s workers do not stop with health risks.",
                                                   "Measures like physical distancing policies and workplace closures also impact different classes of workers in different ways.",
                                 ...
                                 scrolly_section(id="Income Precarity",
                                                 ...
                                                 p("This graph highlights",
                                                  ...
                                                  "for a family of three in urban areas).",
                                                   ...
                                                   "Many of the same occupations that are more likely to be exposed to disease or infections come up here, including taxi drivers, cashiers, and sanitation workers, among many others.",
                                                   style="padding-bottom:200px")),
    ...
    fluidRow(class="alignedrow",
            p("As of March 30th, 2020, we are still at the early stages of this pandemic.",
              ...
              "As this crisis unfolds, the Brookfield Institute is shifting its thinking towards how policymakers can best support the millions of people living in Canada who are being adversely affected by this crisis.", 
    ...
    fluidRow(class="alignedrow",
             div(            p("Current information on COVID-19, including public health recommendations; information on symptoms, diagnosis, and treatment; and the federal government’s COVID-19 Economic Response Plan, can be found on the",
                               ...
                               "."),
                             p("For those who have been laid off, are experiencing reduced hours or income, as well as those who have become sick, require self-isolation or quarantine, or are undertaking caregiving duties, income support is available through the Canadian Emergency Response Benefit, expanded access to EI, and support for businesses. More information on these programs can be found in the",
                               a("Government of Canada’s COVID-19 Economic Response Plan",href="https://www.canada.ca/en/department-finance/economic-response-plan.html"),
